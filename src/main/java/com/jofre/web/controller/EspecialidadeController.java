...
public class EspecialidadeController {
	...
	@GetMapping("/datatables/server/especialista/{id}")
	public ResponseEntity<?> getEspecialidadesPorespecialista(@PathVariable("id") Long id, HttpServletRequest request) {
		
		return ResponseEntity.ok(service.buscarEspecialidadesPorespecialista(id, request)); 
	}
}
